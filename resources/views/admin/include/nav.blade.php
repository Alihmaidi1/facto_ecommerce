        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            <div class="d-flex justify-content-around align-items-center align-items-stretch">
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-icon btn-circle btn-light" href="" target="_blank" title="{{ __('Browse Website') }}">
            ...
            @if (true)
                <div class="d-flex justify-content-around align-items-center align-items-stretch ml-3">
                    <div class="aiz-topbar-item">
                        <div class="d-flex align-items-center">
                            <a class="btn btn-icon btn-circle btn-light" href="" target="_blank" title="{{ __('POS') }}">
                ...
                <div class="aiz-topbar-item">
                    <div class="d-flex align-items-center">
                        <a class="btn btn-soft-danger btn-sm d-flex align-items-center" href="">
                            ...
                            <span class="fw-500 ml-1 mr-0 d-none d-md-block">{{ __('Clear Cache') }}</span>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="align-items-stretch d-flex dropdown " id="lang-change">
                    <a class="dropdown-toggle no-arrow" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="btn btn-icon">
                            <img src="{{ asset('assets/img/flags/'.app()->getLocale().'.png') }}" height="11">
                        </span>
                    </a>
                        ...
                        <span class="d-flex align-items-center">
                            <span class="avatar avatar-sm mr-md-2">
                                ...
                                @if(auth('web')->user()->avatar!=null)
                                    src="{{asset('uploads/admin/'.auth('web')->user()->avatar)}}"
                                    @else
