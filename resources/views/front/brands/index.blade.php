        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 text-lg-left text-center">
                    <h1 class="fw-600 h4">{{ __('All Brands') }}</h1>
                </div>
                <div class="col-lg-6">
                    <ul class="breadcrumb justify-content-center justify-content-lg-end bg-transparent p-0">
                        ...
                        <li class="text-dark fw-600 breadcrumb-item">
                            <a class="text-reset" href="">{{ __('All Brands') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    @foreach ($brands as $brand)
                        <div class="col text-center">
                            <a href=""
                                ...
                                <img src="{{ asset('uploads/brands/'.$brand->logo) }}" class="lazyload h-70px mw-100 mx-auto"
                                    alt="{{ $brand->name }}">
                            </a>
                        </div>
                    @endforeach
