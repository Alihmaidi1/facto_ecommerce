            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{route('banner.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{__('Name')}}" id="name" name="title" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            <input type="url" placeholder="{{__('Url')}}" id="name" name="url" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{__('Message Error')}}" id="name" name="message_error" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="{{__('Rank')}}" id="name" name="rank" class="form-control" required>
