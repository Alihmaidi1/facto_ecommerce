...
<div class="aiz-titlebar text-left mt-2 mb-3">
	<div class="row align-items-center">
		<div class="col">
			<h1 class="h3">{{ __('Add New Page') }}</h1>
		</div>
	</div>
</div>
<div class="card">
	<form action="{{route('page.store')}}" method="POST" enctype="multipart/form-data">
		...
		<div class="card-body">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="{{__('Title')}}" name="title" required>
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="input-group d-block d-md-flex">
						...
						<input type="text" class="form-control w-100 w-md-auto" placeholder="{{ __('Slug') }}" name="url" required>
		...
		<div class="card-body">
			...
			<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" placeholder="{{__('Title')}}" name="meta_title">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<textarea class="resize-off form-control" placeholder="{{__('Description')}}" name="meta_description"></textarea>
			...
			<div class="form-group row">
					...
					<div class="col-sm-10">
						<textarea class="resize-off form-control" placeholder="{{__('Keyword, Keyword')}}" name="meta_keywords"></textarea>
