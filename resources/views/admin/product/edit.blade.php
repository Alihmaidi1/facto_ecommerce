...
<div class="">
    <form class="form form-horizontal mar-top" action="{{route('product.update')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" value="{{$product->name}}" class="form-control" name="name" placeholder="{{ __('Product Name') }}" onchange="update_sku()" required>
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-md-8">
                                <select required class="form-control aiz-selectpicker" name="category_id" id="category_id" data-live-search="true" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="number" required  value="{{$product->minimum_quantity}}" class="form-control" name="minimum_quantity" value="1" min="1" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{$product->tag}}" type="text" class="form-control aiz-tag-input" name="tags[]" placeholder="{{ __('Type and hit enter to add a tag') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input value="{{$product->vedio_link}}" type="text" class="form-control" name="video_link" placeholder="{{ __('Video Link') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-md-8">
                                <select name="colors[]" required class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ __('Choose Attributes') }}">
                                    ...
                                    <option
                                    @foreach($selected_color as $key => $value)
                                    ...
                                    @endforeach
                                     ...
                                     value="{{ $color->id }}" data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>"></option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-md-8">
                                <select name="choice_attributes[]" id="choice_attributes" class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ __('Choose Attributes') }}">
                                    ...
                                    @foreach($selected_property as $key => $value)

                                    @if($value->property_id==$attribute->id)
                                    selected
                                    @endif
                                    @endforeach
                        ...
                        <div class="customer_choice_options" id="customer_choice_options">
                            ...
                            <div class="form-group row">
                                <div class="col-md-3">
                                    <input type="hidden" name="choice_no[]" value="{{$value->property_id}}">
                                    <input type="text" class="form-control" name="choice[]" value="{{$value->property->name}}" placeholder="{{ __('Choice Title') }}" readonly>
                                </div>
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{$value->property_id}}[]". multiple>

                                        @foreach(App\Models\values_property::where("property_id",$value->property_id)->get() as $key1 => $value1)

                                        <option

                                        @foreach(App\Models\property_product_value::where("product_property_id",$value->id)->get() as $key3 => $value3)

                                        @if($value3->value_id==$value1->id) selected @endif
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select required class="form-control aiz-selectpicker" name="curenncy_id" id="brand_id" data-live-search="true">
                                    @foreach ($currencys as $currency)
                                    <option @if($currency->id==$product->currency_id) selected @endif value="{{ $currency->id }}">{{ $currency->code }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input required type="number" value="{{$product->price}}" lang="en" min="0" value="0" step="0.01" placeholder="{{ __('Unit price') }}" name="unit_price" class="form-control" required>
                        ...
                        <div id="show-hide-div">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input required type="number" value="{{$product->quantity}}" lang="en" min="0" value="0" step="1" placeholder="{{ __('Quantity') }}" name="quantity" class="form-control" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input required type="text" value="{{$product->meta_title}}" class="form-control" name="meta_title" placeholder="{{ __('Meta Title') }}">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{__('Description')}}</label>
                            <div class="col-md-8">
                                <textarea required name="meta_description" rows="8" class="form-control">{{$product->meta_description}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" @if($product->free_shipping==1) checked @endif name="free_shipping" value="1">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input required type="number" value="{{$product->warning_count}}" name="low_stock_quantity" value="1" min="0" step="1" class="form-control">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                <input required type="number" value="{{$product->time_delivery}}" class="form-control" name="est_shipping_days" min="1" step="1" placeholder="{{__('Shipping Days')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input required type="number" value="{{$product->tax}}"  min="0" value="0" step="0.01" placeholder="{{ __('Tax') }}" name="tax" class="form-control" required>
                            ...
                            <div class="form-group col-md-6">
                                <select required class="form-control aiz-selectpicker" name="tax_type">
                                    <option @if($product->tax_type=="amount") selected @endif value="amount">{{__('Flat')}}</option>
                                    <option @if($product->tax_type=="percent") selected @endif value="percent">{{__('Percent')}}</option>
                                </select>
                                @error('tax_type')
                                <span style="color:red;font-size:11px">{{$message}}</span>
                            @enderror
