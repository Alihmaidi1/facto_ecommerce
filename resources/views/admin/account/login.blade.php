                ...
                <div class="card text-left">
                    <div class="card-body">
                        <div class="mb-5 text-center">
                            ...
                            <h1 class="h3 text-primary mb-0">{{ __('Welcome to') }} {{ env('APP_NAME') }}</h1>
                                ...
                                @if(env('MAIL_USERNAME') != null && env('MAIL_PASSWORD') != null)
                                    <div class="col-sm-6">
                                        <div class="text-right">
                                            <a href="{{ route('password.request') }}" class="text-reset fs-14">{{__('Forgot password ?')}}</a>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                ...
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>123456</td>
                                            <td><button class="btn btn-info btn-xs" onclick="autoFill()">{{ __('Copy') }}</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
