...
<div class="row">
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{route('copon.update')}}" method="POST" enctype="multipart/form-data">
                	@csrf
                    <input type="hidden" value="{{$copon->id}}" name="id"/>
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{__('Name')}}</label>
                        <div class="col-md-9">
                            <input type="text" value="{{$copon->value}}" placeholder="{{__('Name')}}" id="name" name="name" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="{{$copon->code}}" placeholder="{{__('Code')}}" id="name" name="code" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="select2 form-control aiz-selectpicker" name="type" data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                ...
                                <option @if($copon->type=='precent') selected @endif value="precent">precent</option>
                                <option @if($copon->type=='flat') selected @endif value="flat">flat</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" value="{{$copon->value}}" placeholder="{{__('Value')}}" id="name" name="value" class="form-control" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="date" value="{{$copon->date_start_at}}" class="form-control" name="date_start_at"/>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="date" value="{{$copon->date_end_at}}" class="form-control" name="date_end_at"/>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <select name="products[]"   class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ __('Choose Attributes') }}">
                                ...
                                @foreach($copon->products as $key => $product1)

                                @if($product->id==$product1->id) selected @endif

                                @endforeach



                                value="{{ $product->id }}" data-content="<span><span>{{ $product->name }}</span></span>"></option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <select name="categorys[]"   class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ __('Choose Attributes') }}">
                                ...
                                @foreach($copon->categorys as $key => $category1)

                                @if($category->id==$category1->id) selected @endif

                                @endforeach



                                value="{{ $category->id }}" data-content="<span><span>{{ $category->name }}</span></span>"></option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-9">
                            <select name="brands[]"  class="form-control aiz-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ __('Choose Attributes') }}">
                                ...
                                @foreach($copon->brands as $key => $brand1)

                                @if($brand->id==$brand1->id) selected @endif

                                @endforeach



                                value="{{ $brand->id }}" data-content="<span><span>{{ $brand->name }}</span></span>"></option>
                                @endforeach
                            </select>
                        </div>
